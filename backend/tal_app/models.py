...
class Episode(models.Model):
    episode_num = models.IntegerField(unique=True, primary_key=True)
    ...
    episode_descript = models.CharField(max_length=500, blank = True, default = None)
...
class Episode_Link(models.Model):
    episode_link_num = models.IntegerField(unique=True, primary_key=True)
